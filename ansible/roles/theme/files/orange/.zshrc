...
theme() { ANSIBLE_CONFIG=~/debian/ansible/ansible.cfg ansible-playbook ~/debian/ansible/site.yml --tags theme -e dotfiles_theme="$1" --ask-become-pass && command -v i3-msg >/dev/null 2>&1 && i3-msg reload; }
