# Monokai Pro adaptation of romkatv/powerlevel10k's official "classic"
# style template (config/p10k-classic.zsh, fetched verbatim from upstream).
# Only the identity-color vars are overridden — via the same 256-color
# nearest-index mapping used elsewhere in this repo for tools without hex
# support (see docs/monokai-pro-palette.md) — everything else is the real,
# unmodified upstream default: OS_ICON/DIR/VCS_CLEAN/VCS_UNTRACKED/
# STATUS_OK -> green(150) or fg(231), VCS_MODIFIED -> yellow(221),
# PROMPT_CHAR_ERROR/STATUS_ERROR(_SIGNAL/_PIPE) -> pink(204),
# DIR_FOREGROUND -> purple(147). Full fidelity depends on the terminal's
# 256-color palette being remapped to Monokai Pro hex (same caveat as
# newsboat/cmus/taskwarrior).
#
